...
public class JwtUtil {
    ...
    // Token expiration time - 24 hours (86400 seconds) - configurable via environment
    private static final long EXPIRATION_TIME = Long.parseLong(System.getenv().getOrDefault("JWT_EXPIRATION", "86400")) * 1000;
